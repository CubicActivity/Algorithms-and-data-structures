...
public class Main {
    ...
    public static void main(String [] args){
        ...
        //find smallest element insert first and delete it and increment min pos
        ...
        for(int i=0;i<n;i++){
            ...
            int counter=0,counterSmallest=0;
//              System.out.println("Current one is"+tmp.element);
            while(true){
                if(tmp.element<min && tmp.element!=min){
                    min=tmp.element;
                    counterSmallest=counter;

//                      System.out.println(counter+" counter min is "+tmp.element);
                }
                if(tmp.succ!=null) {
                    tmp = tmp.succ;
                    counter++;
            ...
            tmp=list.getFirst();
            for(int k=0;k<counterSmallest+i;k++){
                if(tmp.succ!=null) {
                    tmp = tmp.succ;
                }
            }
            ...
            //it is adding an unnecessary 6
            if(counterSmallest!=0){
//                  System.out.println(tmp.element+"has been inserted before "+tmp2.element);
                list.delete(tmp);

//              if(i==0)
                list.insertBefore(tmp.element,tmp2);
//              else list.insertAfter(tmp.element,tmp2);
            }
