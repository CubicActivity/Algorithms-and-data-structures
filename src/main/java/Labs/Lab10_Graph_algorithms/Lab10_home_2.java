...
public class Lab10_home_2 {
    public static void main(String[] args) {
        ...
        AdjacencyListGraph<String> cityNetwork = new AdjacencyListGraph<>();
        ...
        for (int i = 0; i < M; i++) {
            ...
            cityNetwork.addEdge(city1, city2, cost);
//            System.out.println("added edge"+city1+" "+city2+" "+cost);
        }
...
//            System.out.println(key+ " " + map.get(key));
            Map<String, Integer> paths = cityNetwork.shortestPath(key);

            Map<String, Integer> distance = cityNetwork.shortestPath(key);

//            System.out.println("Minimalni ceni so pocetno teme "+key+" se:");
            for(String dest: distance.keySet()){
                if(dest.equals(map.get(key))) {
//                    System.out.println("Cena od teme" + key + " do teme" + dest + " e " + distance.get(dest));
                    total+=distance.get(dest);
                }
            }
