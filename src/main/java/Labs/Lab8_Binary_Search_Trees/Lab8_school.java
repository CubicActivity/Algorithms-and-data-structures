...
public class Lab8_school {
    ...
    public static void main(String[] args) {
        ...
        for(int i=0;i<n+q;i++){
            ...
            if(parts[0].equals("insert")){
                ...
                int total=0;
                //find all the elements with a value > parts[1]

                BNode<Integer> root = bst.getRoot();

                int res = NodesGtK(Integer.parseInt(parts[1]),root,0);
    ...
    public static int NodesGtK(int k, BNode<Integer> node,int total){
        ...
        total+=NodesGtK(k, node.left,0);
        total+=NodesGtK(k, node.right,0);
//         System.out.println("Incremented" + total);
